...
- Expects drag-and-drop interactions to snap immediately and remain visually stable, without pieces briefly jumping back, returning, or flickering during rapid successive moves. Confidence: 0.85
- Prefers technical behavior and fallback mechanisms to be explained in plain, concrete language rather than unexplained infrastructure terms (for example, clearly distinguishing instant realtime updates from delayed polling). Confidence: 0.8
